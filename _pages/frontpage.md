...
* Post-processing and analysis using Python, focusing on:
  ...
  * Flux partitioning
  * Comparison between oceanic and glacier-influenced environments

This hands-on experience will provide participants with the skills needed to handle, process, and interpret real-world eddy covariance data from both oceanic and polar environments.
